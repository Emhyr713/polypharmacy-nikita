...
version = "6"
# Входные данные
file_path = f"doccano\\data\\data_{version}.jsonl"

# Выходные данные
file_path_relation = f"doccano\\data\\data_relations_{version}.csv"
file_path_bio = f"doccano\\data\\data_bio_{version}.json"
file_path_log = f"doccano\\data\\data_log_{version}.txt"
