...
class BayesianTrainer:
    ...
    def _compute_loss(
            ...
            max_drugs_per_combo: Optional[int] = None,
        ...
        for start in range(0, len(selected_combinations), batch_size):
            ...
            for bi, combo in enumerate(batch_combos):
                ...
                for se_idx in target_dict:
                    ...
                    combined_prob = (combined_prob / target_scale).clamp(0.0, 1.0)
                    target_dict[se_idx] = combined_prob.item()
...
if __name__ == "__main__":
    ...
    final_probs, final_loss = trainer.train_model(
        ...
        final_file=f"{DIR}data/probabilities_opt_10_6_pytorch_del_3_comb_10.json",
