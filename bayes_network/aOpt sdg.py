...
def calculate_probabilities_with_evidence(network_nodes, evidence=None):
    """
...
class BayesianNetworkOptimizer:
    ...
    def _calculate_loss(self, x_flat, log_details=False):
        ...
        for drug_name, se_data_list in self.orlov_data.items():
            ...
            calculated_marginals = calculate_probabilities_with_evidence(network, evidence)
...
if __name__ == "__main__":
    graph_path = 'bayes_network\\graphs_4.json'
    orlov_path = 'bayes_network\\Orlov.json'
    drug_states_path = 'bayes_network\\drug_states.json'
